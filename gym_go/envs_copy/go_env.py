    ...
    def render(self, mode ='terminal'): 
        if mode == 'terminal':
            ...
            def on_draw():
                ...
                elements.append(rendering.draw_grid(batch, delta, self.size, lower_grid_coord, upper_grid_coord))

                # info on top of the board
                elements.append(rendering.draw_info(batch, window_width, window_height, upper_grid_coord, self.state_))

                # Inform user what they can do
                elements.append(rendering.draw_command_labels(batch, window_width, window_height))

                elements.append(rendering.draw_title(batch, window_width, window_height))

                # draw the pieces
                elements.append(rendering.draw_pieces(batch, lower_grid_coord, delta, piece_r, self.size, self.state_))
